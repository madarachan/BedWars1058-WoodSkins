...
public class CommandManager implements CommandExecutor {
    ...
    public void command(Object object) {
        for (Method method : object.getClass().getMethods()) {
            WoodSkinsCommand annotation = method.getAnnotation(WoodSkinsCommand.class);
        ...
        for (int i = -1; i <= args.length - 1; i++) {
            ...
            for (String usage : registeredCommandTable.keySet()) {
                if (usage.equals(sb.toString())) {
                    ...
                    WoodSkinsCommand annotation = wrapper.annotation;
    ...
    final static class RegisteredCommand {
        ...
        RegisteredCommand(Method method, Object instance, WoodSkinsCommand annotation) {
            this.method = method;
